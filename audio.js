...
const SOUNDS = {
  ...
  SCREECH: [1.0, 0, 450, 0.02, 0.12, 0.3, 3, 1.8, 15, 0, 0, 0, 0, 0, 0, 0, 0, 0.5, 0.05, 0],
  COLLECT: [1.0, 0, 800, 0.01, 0.05, 0.1, 0, 1, 10, 0, 0, 0, 0, 0, 0, 0, 0, 0.8, 0.05, 0],
  BOOST: [1.5, 0, 200, 0.1, 0.1, 0.5, 2, 0.5, 10, 0, 0, 0, 0, 0, 0, 0, 0, 0.8, 0.1, 0],
  POP: [0.8, 0, 150, 0.01, 0.01, 0.08, 4, 2, 10, 0, 0, 0, 0, 0, 0, 0, 0, 0.5, 0.05, 0],
  GEAR: [2, 0, 80, 0.01, 0.02, 0.1, 4, 3.5, -15, 0, 0, 0, 0, 0, 0, 0, 0, 0.8, 0.02, 0],
  BEEP: [1, 0, 800, 0.01, 0.05, 0.2, 1, 0.5, 10, 0, 0, 0, 0, 0, 0, 0, 0, 0.8, 0.05, 0],
  COLLISION: [1.8, 0, 240, 0.01, 0.1, 0.4, 4, 1.3, 0, 0, 0, 0, 0, 0.4, 0, 0.5, 0.1, 0.4, 0.02, 0],
};
